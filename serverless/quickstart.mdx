...
You'll need to create an input file to properly test your handler locally. Create a file named `test_input.json` in the same directory and add the following code:
...
```sh
python handler.py test_input.json
```
